...
border-bottom:1px solid #ccc;
   ...
   <section id="content">
<br>Wildcard Search (max 35 results)<br>
...
<?php 
$sql = 'SELECT * FROM accessoryspecs WHERE partnumber LIKE "%' . $_GET['pn'] . '%" ORDER BY partnumber LIMIT 35';
...
var lang = container.handsontable('getDataAtRowProp',changes,"lang");
			...
			{where: "partnumber = '"+pnum+"' AND fieldname = '"+fnam+"' AND lang = '"+lang+"'",
			 removerow: "TRUE",
...
if (r==true)
 ...
 return;
  ...
  $.ajax({
    ...
    data: {"data": handsontable.getData(), "fields": jFields, "rows": changeRows, "table": "accessoryspecs"}, //returns all cells' data
    dataType: 'json',
    type: 'POST',
