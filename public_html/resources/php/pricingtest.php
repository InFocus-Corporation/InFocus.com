...
$sql = 'SELECT REPLACE(CalculatedPricing.PartNumber,"-KIT","") AS PartNumber, CalculatedPricing.Category, CurrentBom, MAP, Dist, CalculatedPricing.Description, listtitle, weight 
...
UNION ALL SELECT CalculatedAccessory.PartNumber, CalculatedAccessory.Category, CurrentBom, MAP, BaseX, CalculatedAccessory.Description, listtitle, NULL
	FROM infocus_internal.CalculatedAccessory LEFT JOIN InFocus.producttext on producttext.partnumber = CalculatedAccessory.PartNumber';
