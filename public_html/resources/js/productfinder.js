...
displayInsert = '<li class="liresults" style="list-style:none;background: -webkit-linear-gradient(#E9E9E9,rgb(255, 253, 228) 30px, white );background: -o-linear-gradient(#E9E9E9,rgb(255, 253, 228) 30px, white  );background: -moz-linear-gradient(#E9E9E9,rgb(255, 253, 228) 30px, white );background: linear-gradient(#E9E9E9,rgb(255, 253, 228) 30px, white);"><div class="C2 Col"><img src="/resources/images/InFocus-INF5520" width="75%">	</div><div class="Col" style="margin-left:20px;"><h6><a href="/displays/">Have you thought of using an interactive touch display?</a></h6><span style="font-size:70%"></span><ul style="list-style:disc; display:block; vertical-align:top;"><li>Great for bright environments</li><li>Ultimate Colaboration Tool</li></ul> </div><div style="float:right;"><a href="/displays"><button>Learn More</button></a></div></li>';
