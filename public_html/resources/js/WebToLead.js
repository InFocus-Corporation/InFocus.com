...
var APAC1Array = ['Australia', 'Bangladesh', 'Bhutan', 'Brunei Darussalam', 'Cambodia', 'Fiji', 'India', 'Japan', 'Korea, Democratic Peoples Republic of', 'Korea, Republic of', 'Lao Peoples Democratic Republic', 'Micronesia, Federated States of', 'Nepal', 'New Zealand', 'Pakistan', 'Palau', 'Pitcairn', 'Singapore', 'Sri Lanka', 'Thailand', 'Timor-leste', 'Tokelau', 'Viet Nam'];
...
if(1==2){}
	...
	document.getElementById('campaign_id').value = '343da04a-85a5-da5e-0291-50cfa02f86b9';
	document.getElementById('team_id').value = '1';
	document.getElementById('assigned_user_id').value = 'c7e87367-bb71-1062-4983-50802a885554';
}
	...
	document.getElementById('campaign_id').value = '343da04a-85a5-da5e-0291-50cfa02f86b9';
	document.getElementById('team_id').value = '1';
	document.getElementById('assigned_user_id').value = '81af28fd-bb22-db27-15ef-50802ad925dc';
}

			else if(TAM3index >= 0 && formName == 'GetAQuote'){
	document.getElementById('campaign_id').value = '343da04a-85a5-da5e-0291-50cfa02f86b9';
	document.getElementById('team_id').value = '1';
	document.getElementById('assigned_user_id').value = '917b0b22-a0fc-614b-59e9-50802a2b4b0d';
}
	...
	document.getElementById('assigned_user_id').value = '81af28fd-bb22-db27-15ef-50802ad925dc';
			...
			else if(TAM3index >= 0 && formName == 'MPDemo'){
	document.getElementById('campaign_id').value = '59eeea26-0ad3-374b-7f7f-50cfa327a67c';
	document.getElementById('team_id').value = '1';
	document.getElementById('assigned_user_id').value = '917b0b22-a0fc-614b-59e9-50802a2b4b0d';
}
