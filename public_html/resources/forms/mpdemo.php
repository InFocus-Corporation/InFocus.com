...
if(!empty($_POST)){
$to = "emea-sales@infocus.com";
$subject = "Fragen Sie nach einer Vorführung";
$message = "
Vorname:" . $_POST['first_name'] . "
Nachname" . $_POST['last_name'] . "
Berufsbezeichnung:" . $_POST['title'] . "
Telefon:" . $_POST['phone_work'] . "
Email-Adresse:" . $_POST['email1'] . "
Organisation:" . $_POST['account_name'] . "
Adresse:" . $_POST['primary_address_street'] . "
Stadt:" . $_POST['primary_address_city'] . "
Land:" . $_POST['primary_address_country'] . "
PLZ:" . $_POST['primary_address_postalcode'] . "
...
<form id="WebToLeadForm" method="POST" name="WebToLeadForm" <?php if($lang != "en"){
echo ' action=""';}
?>>
...
if($lang == "en"){
echo '
<button onclick="submit_form();" type="button">'.  $translate['Send'] . '</button>';}
else{
echo '
...
<input id="campaign_id" type="hidden" name="campaign_id" value="MPDemo" />
...
<input id="req_id" type="hidden" name="req_id" value="last_name;phone_work;primary_address_country;primary_address_city;primary_address_street;account_name;first_name;email1;" />
