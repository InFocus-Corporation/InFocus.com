...
echo "<script src='http://code.jquery.com/jquery-1.9.1.js'></script><br>RMA submitted<br><br><script>$(function(){
...
if($to == "support@infocus.com"){

$connection = mysqli_connect('67.43.0.33','InternalAdmin','nIinmFd0Aclu', 'callcenterdatabases',3306);
$pn = mysqli_real_escape_string($connection, strtoupper($product));


$result = mysqli_query($connection,'SELECT `ID` FROM ticket WHERE `Serial` =  "' . $_POST['serial_number'] . '" AND ABS(DATEDIFF(`Created`,NOW())) < 10');
...
`Notes` = "' . $_POST['notes'] . '",
`SymptomNotes` = "' . $_POST['Troubleshooting'] . '",
...
`Created` = NOW(),
`CallAction` = "Online-RMA",
`CallRef` = "Online-RMA",
`CaseStatus` = "Online-RMA"';
...
$caseNum = mysqli_insert_id($connection);
...
$result = mysqli_query($connection,'UPDATE ticket SET 
`FirstName` = "' . $_POST['first_name'] . '",
`LastName` = "' . $_POST['last_name'] . '",
`Phone` = "' . $_POST['phone_number'] . '",
`Organization` = "' . $_POST['organization'] . '",
...
`CallAction` = "Online-RMA",
`CallRef` = "Online-RMA",
`CaseStatus` = "Online-RMA Updated" WHERE `ID` =  "' . $caseNum . '"');
...
var select = document.getElementById("symptom");

$("#completetroub").slideDown(1000);
...
case 1:
$("#SympAbDr").slideDown(1000);
	break;

case 2:
$("#SympAuNo").slideDown(1000);
	break;

case 3:
$("#SympAudi").slideDown(1000);
	break;

case 4:
$("#SympBoLi").slideDown(1000);
	break;

case 5:
$("#SympBrUn").slideDown(1000);
	break;

case 6:
$("#SympCoUn").slideDown(1000);
	break;

case 7:
$("#SympCoCo").slideDown(1000);
	break;

case 8:
$("#SympCoVS").slideDown(1000);
	break;

case 9:
$("#SympCont").slideDown(1000);
	break;

case 10:
$("#SympCoOu").slideDown(1000);
	break;

case 11:
$("#SympCosm").slideDown(1000);
	break;

case 12:
$("#SympDrCa").slideDown(1000);
	break;

case 12:
$("#SympImBa").slideDown(1000);
	break;

case 14:
$("#SympImBl").slideDown(1000);
	break;

case 15:
$("#SympImBr").slideDown(1000);
	break;

case 16:
$("#SympImCo").slideDown(1000);
	break;

case 17:
$("#SympImDi").slideDown(1000);
	break;

case 18:
$("#SympImFF").slideDown(1000);
	break;

case 19:
$("#SympImFo").slideDown(1000);
	break;

case 20:
$("#SympImGh").slideDown(1000);
	break;

case 21:
$("#SympImLi").slideDown(1000);
	break;

case 22:
$("#SympImNG").slideDown(1000);
	break;

case 23:
$("#SympImPa").slideDown(1000);
	break;

case 24:
$("#SympIRWR").slideDown(1000);
	break;

case 25:
$("#SympKeLE").slideDown(1000);
	break;

case 26:
$("#SympLaSh").slideDown(1000);
	break;

case 27:
$("#SympLoCa").slideDown(1000);
	break;
	
case 28:
$("#SympMech").slideDown(1000);
	break;

case 29:
$("#SympMeFi").slideDown(1000);
	break;

case 30:
$("#SympMiWP").slideDown(1000);
	break;

case 31:
$("#SympNoIm").slideDown(1000);
	break;

case 32:
$("#SympNoLi").slideDown(1000);
	break;

case 33:
$("#SympNoMF").slideDown(1000);
	break;

case 34:
$("#SympNoNC").slideDown(1000);
	break;

case 35:
$("#SympNoPo").slideDown(1000);
	break;

case 36:
$("#SympNoSC").slideDown(1000);
	break;

case 37:
$("#SympPixe").slideDown(1000);
	break;

case 38:
$("#SympPrSh").slideDown(1000);
	break;

case 39:
$("#SympSoFa").slideDown(1000);
	break;

case 40:
$("#SympUnCC").slideDown(1000);
	break;
	
case 41:
$("#SympVCMe").slideDown(1000);
	break;
	
case 42:
$("#SympWiFu").slideDown(1000);
	break;
	
case 43:
$("#SympWRUS").slideDown(1000);
	break;
}
...
case 1:
$("#SympAbDr").slideUp(1000);
	break;

case 2:
$("#SympAuNo").slideUp(1000);
	break;

case 3:
$("#SympAudi").slideUp(1000);
	break;

case 4:
$("#SympBoLi").slideUp(1000);
	break;

case 5:
$("#SympBrUn").slideUp(1000);
	break;

case 6:
$("#SympCoUn").slideUp(1000);
	break;

case 7:
$("#SympCoCo").slideUp(1000);
	break;

case 8:
$("#SympCoVS").slideUp(1000);
	break;

case 9:
$("#SympCont").slideUp(1000);
	break;

case 10:
$("#SympCoOu").slideUp(1000);
	break;

case 11:
$("#SympCosm").slideUp(1000);
	break;

case 12:
$("#SympDrCa").slideUp(1000);
	break;

case 12:
$("#SympImBa").slideUp(1000);
	break;

case 14:
$("#SympImBl").slideUp(1000);
	break;

case 15:
$("#SympImBr").slideUp(1000);
	break;

case 16:
$("#SympImCo").slideUp(1000);
	break;

case 17:
$("#SympImDi").slideUp(1000);
	break;

case 18:
$("#SympImFF").slideUp(1000);
	break;

case 19:
$("#SympImFo").slideUp(1000);
	break;

case 20:
$("#SympImGh").slideUp(1000);
	break;

case 21:
$("#SympImLi").slideUp(1000);
	break;

case 22:
$("#SympImNG").slideUp(1000);
	break;

case 23:
$("#SympImPa").slideUp(1000);
	break;

case 24:
$("#SympIRWR").slideUp(1000);
	break;

case 25:
$("#SympKeLE").slideUp(1000);
	break;

case 26:
$("#SympLaSh").slideUp(1000);
	break;

case 27:
$("#SympLoCa").slideUp(1000);
	break;
	
case 28:
$("#SympMech").slideUp(1000);
	break;

case 29:
$("#SympMeFi").slideUp(1000);
	break;

case 30:
$("#SympMiWP").slideUp(1000);
	break;

case 31:
$("#SympNoIm").slideUp(1000);
	break;

case 32:
$("#SympNoLi").slideUp(1000);
	break;

case 33:
$("#SympNoMF").slideUp(1000);
	break;

case 34:
$("#SympNoNC").slideUp(1000);
	break;

case 35:
$("#SympNoPo").slideUp(1000);
	break;

case 36:
$("#SympNoSC").slideUp(1000);
	break;

case 37:
$("#SympPixe").slideUp(1000);
	break;

case 38:
$("#SympPrSh").slideUp(1000);
	break;

case 39:
$("#SympSoFa").slideUp(1000);
	break;

case 40:
$("#SympUnCC").slideUp(1000);
	break;
	
case 41:
$("#SympVCMe").slideUp(1000);
	break;
	
case 42:
$("#SympWiFu").slideUp(1000);
	break;
	
case 43:
$("#SympWRUS").slideUp(1000);
	break;
}	
	
lastsymp = 	select.selectedIndex;
...
document.getElementById("onlinerma").submit();
...
<body style="width:700px;background: #f7f7f7;">
