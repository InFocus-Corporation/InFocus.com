...
window.location = "/#globalcontactus";
}
</script>
 </HEAD>
<BODY>
...
<div style="width:49%;float:left;">
 <h3>Beratung</h3>
 Sie wollen ein InFocus Gerät kaufen? Wir beraten Sie gerne!<br>
 Telefon: +49 89 416 1562-50<br>
 oder nutzen Sie das Kontaktformular.
 </div>
 <div style="width:49%;float:right;">
 <h3>Support</h3>
 Sie benötigen Unterstützung für lhr InFocus Gerät?<br>
 Support Hotline: +49 800 18 13 649<br>
 <a href="//service.infocus.info">oder klicken Sie hier > </a>
 </div>
<ul class="wrap" style="clear:both;">
<li>
...
<li>
<label class="top" for="description"><strong><?php echo $translate['Notes'];?></label>
...
<input id="req_id" type="hidden" name="req_id" value="last_name;first_name;email1;phone_work;account_name;primary_address_country;description;" />
