...
<?php 
$sql = 'SELECT * FROM displays WHERE partnumber LIKE "%' . $_GET['pn'] . '%" LIMIT 20';
...
if (r==true)
 ...
 return;
  ...
  $.ajax({
    ...
    data: {"data": handsontable.getData(), "fields": jFields, "rows": changeRows, "table": "displays"}, //returns all cells' data
    dataType: 'json',
    type: 'POST',
