...
getSeriesText();
//Set Canonical
echo PHP_EOL . '<link rel="canonical" href="http://' .  $_SERVER['SERVER_NAME'] . '/projectors/' . $series . '"/>' . PHP_EOL;
?>
<style>
.feature-list  ul {
 width:46%;  
...
<div class="tabs">
  ...
  <nav role='navigation' class="C10 transformer-tabs tabs-wrapper">
    <ul>
				...
				<li><a id="specstab" href="#specs"><?php echo translate('Specifications'); ?></a></li>
...
<?PHP getSeriesPanels("/projectors/"); ?>
			</ul>
