...
<h3 style="margin-top:3.5rem;margin-left:2rem;">Warranty Check</h3>

<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" style="background:transparent;box-shadow:none;border:none;margin: 0 2rem;">
...
<input type="text" size="20" id="SN" name="SN" value="<?php echo $SN ?>"/>
...
<p style="color:grey;font-size:small;text-align:center;">Note: Warranty information generated by this tool is subject to change without notice.  Final warranty validation is determined by date of purchase on invoice.</p>
