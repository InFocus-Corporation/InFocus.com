...
<?= translate('Where to Buy') ;?>
	...
	<div class="tab-shadow"></div>
		...
		<ul class="floatList" style="overflow:hidden">
				<li><div>
				<a href="http://dev.infocus.com/accessories/mondopad-accessories"><section class="stretch-wrap60">
<div><img src="<?php echo imagethumb('mpbtaccessories','135');?>" alt="<?php echo translate('Accessories for');?><br>Mondopad <?php echo translate('and');?> BigTouch"/></div></section>
	...
	<span><a href="http://dev.infocus.com/accessories/mondopad-accessories" class="view-all" ><?= translate('View All');?></a>
...
echo '<br><a href="http://www.infocusstore.com/s?defaultSearchTextValue=Search&searchKeywords=mondopad&Action=submit&field_brandtextbin=&field_subjectbin=7448597011&field_color_map=&field_price=&field_size_name=&searchRank=salesrank&searchSize=12&searchPage=1&searchBinNameList=brandtextbin%2Csubjectbin%2Ccolor_map%2Cprice%2Csize_name" >'. translate('Go to Store') . '</a>';
		...
		?>
					...
					<a href="http://dev.infocus.com/accessories/cables"><section class="stretch-wrap60">
<div><img src="<?= imagethumb('cables','192');?>" alt="<?= translate('Cables and Adapters');?>"/></div></section>
	...
	<span><a href="http://dev.infocus.com/accessories/cables" class="view-all" ><?= translate('View All');?></a>
...
echo '<br><a href="http://www.infocusstore.com/Cables-Adapters-Accessories/b/7448598011?ie=UTF8&title=Cables+%26+Adapters" >'. translate('Go to Store') . '</a>';
		...
		?>
					...
					<a href="http://dev.infocus.com/accessories/cases"><section class="stretch-wrap60">
<div ><img src="<?= imagethumb('cases','192');?>" alt="<?= translate('Cases');?>"/></div></section>
						...
						<span><a href="http://dev.infocus.com/accessories/cases" class="view-all"><?= translate('View All');?></a>
...
echo '<br><a href="http://www.infocusstore.com/Cases-Accessories/b/7448599011?ie=UTF8&title=Cases" >'. translate('Go to Store') . '</a>';
		...
		?>
					...
					<a href="http://dev.infocus.com/accessories/lamps" ><section class="stretch-wrap60">
<div ><img src="<?= imagethumb('lamps','192');?>" alt="<?= translate('Lamps');?>"/></div></section>
						...
						<span><a href="http://dev.infocus.com/accessories/lamps" class="view-all"><?= translate('View All');?></a>
...
echo '<br><a href="http://www.infocusstore.com/Lamps-Accessories/b/7448620011?ie=UTF8&title=Lamps" >'. translate('Go to Store') . '</a>';
		...
		?>
					...
					<a href="http://dev.infocus.com/accessories/lenses" ><section class="stretch-wrap60">
<div  ><img src="<?= imagethumb('lenses','192');?>" alt="<?= translate('Lenses');?>"/></div></section>
						...
						<span><a href="http://dev.infocus.com/accessories/lenses" class="view-all"><?= translate('View All');?></a>
...
echo '<br><a href="http://www.infocusstore.com/Lamps-Accessories/b/7448620011?ie=UTF8&title=Lamps" >'. translate('Go to Store') . '</a>';
		...
		?>
					...
					<a href="http://dev.infocus.com/accessories/misc"><section class="stretch-wrap60">
<div ><img src="<?= imagethumb('misc','192');?>" alt="<?= translate('Miscellaneous');?>"/></div></section>
						...
						<span><a href="http://dev.infocus.com/accessories/misc" class="view-all"><?= translate('View All');?></a>
...
echo '<br><a href="http://www.infocusstore.com/Filters-Accessories/b/7448619011?class=tier2" >'. translate('Go to Store') . '</a>';
		...
		?>
					...
					<a href="http://dev.infocus.com/accessories/mounts" ><section class="stretch-wrap60">
<div ><img src="<?= imagethumb('mounts','192');?>" alt="<?= translate('Mounts and Stands');?>"/></div></section>
						...
						<span><a href="http://dev.infocus.com/accessories/mounts" class="view-all" ><?= translate('View All');?></a>
...
echo '<br><a href="http://www.infocusstore.com/Mounts-Stands-Accessories/b/7448623011?class=tier2" >'. translate('Go to Store') . '</a>';
		...
		?>
					...
					<a href="http://dev.infocus.com/accessories/remotes" ><section class="stretch-wrap60">
<div ><img src="<?= imagethumb('remotes','192');?>" alt="<?= translate('Remotes');?>"/></div></section>
						...
						<span><a href="http://dev.infocus.com/accessories/remotes" class="view-all"><?= translate('View All');?></a>
...
echo '
				<li><div>
					<a href="http://dev.infocus.com/accessories/screens"><section class="stretch-wrap60">
<div ><img src="' . imagethumb('screens' , '192') . '" alt="'. translate('Screens') . '"/></div></section>
						...
						<span><a href="http://dev.infocus.com/accessories/screens" class="view-all" >'. translate('View All') . '</a><br><a href="http://www.infocusstore.com/Screens-Accessories/b/7448625011?ie=UTF8&title=Screens" >'. translate('Go to Store') . '</a></span>
				</div></li>';
			}
		?>
				<li><div>
					<a href="http://dev.infocus.com/accessories/software" ><section class="stretch-wrap60">
<div ><img src="<?= imagethumb('software','192');?>" alt="<?= translate('Software');?>"/></div></section>
						...
						<span><a href="http://dev.infocus.com/accessories/software" class="view-all" ><?= translate('View All');?></a>
						<?php if($lang != "de"){ 
echo '<br><a href="http://www.infocusstore.com/Software-Accessories/b/7288445011?ie=UTF8&title=Software" >'. translate('Go to Store') . '</a>';
		...
		?>
					...
					<a href="http://dev.infocus.com/accessories/services" ><section class="stretch-wrap60">
<div ><img src="<?= imagethumb('services','192');?>" alt="<?= translate('Warranties and Services');?>"/></div></section>
						...
						<span><a href="http://dev.infocus.com/accessories/services" class="view-all" ><?php echo translate('View All');?></a>
...
echo '<br><a href="http://www.infocusstore.com/Warranties-Accessories/b/7448626011?class=tier2" >'. translate('Go to Store') . '</a>';
		...
		?>
					...
					<a href="http://dev.infocus.com/accessories/networking" ><section class="stretch-wrap60">
<div><img src="<?= imagethumb('networking','192');?>" alt="<?= translate('Wireless and Networking');?>"/></div></section>
						...
						<span><a href="http://dev.infocus.com/accessories/networking" class="view-all"><?= translate('View All');?></a>
