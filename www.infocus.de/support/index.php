...
<div class="content">
<div class="C8">
<h4 class="pane-title" >Willkommen beim InFocus Kundensupport</h4>
...
Unser Ziel ist es, Ihr Anliegen so schnell und lösungsorientiert wie möglich zu betreuen. Unser Team besteht aus hochqualifizierten Mitarbeitern, die gemeinsam durch Teamwork, Flexibilität und kontinuierliche Verbesserung unserer Services Supportanfragen in zufriedene Kunden verwandeln wollen. Bitte zögern Sie nicht, uns anzurufen oder uns eine E-Mail zu schreiben. Wir helfen Ihnen gerne.
<div style="padding-top:20px;">

<a href="//service.infocus.info" target="blank" class="Button-1" style="color:white;"><?php echo $translate['Contact Us'];?></a>
&nbsp;&nbsp;&nbsp;&nbsp;
<a href="/calculator" class="Button-1" style="color:white;"><?php echo $translate['Projector Calculator'];?></a>
</div></div>
...
<div style="background-color:lightgrey;border-radius:10px;padding:10px;margin-bottom:10px;">Um Ihre Produkt schneller zu finden,<br> fangen Sie einfach an, es in die Box unten einzutippen.</div>
			...
			<?php 
			$sql = "SELECT partnumber, productgroup FROM producttext WHERE partnumber NOT LIKE 'A%' AND partnumber NOT LIKE 'C%' AND partnumber NOT LIKE 'DP%' AND productgroup != 'Accessory' AND productgroup != 'Series' AND lang = '" . $lang . "' ORDER BY partnumber";
			...
			?>      
			</select><INPUT type="button" id="btn" class="Button-1" style="display:inline;margin-left:60px;margin-top:10px;" value="Suchen" onclick="window.location = document.getElementById('combobox').value;"  /><br>
			</div>
			</div>
...
<h6>Produktregistrierung</h6>
<div >Durch eine Produktregistrierung können wir Ihren Garantiestatus genauer verfolgen. Außerdem können wir Sie so über wichtige Updates informieren. Bitte nehmen Sie sich die Zeit und füllen unser Registrierungsformular aus.</div>
<br/><br/>
<a href="/resources/forms/register" class="Button-1 form-box" style="color:white;">Registrieren</a>

</div>

<div class="C3 Col" style="vertical-align:top;">
<h6>Support</h6>
&gt; <a target="" href="/support/warrantyvt.php" class="warval-box">Garantiestatus</a><br/>
<br/>
<script>
$(".warval-box").colorbox({iframe:true, innerWidth:400, innerHeight:200});
</script>
<Strong style="color:grey;">U.S. &amp; Canada</Strong><br/>
&gt; <a href="#RMAWorldMap-popup" class="colorbox-inline">Get Warranty Service</a><br/>
&gt; <a href="/support/authorized-service-centers#ABU">Find a Repair Provider</a><br/>

<br/>
<br/>

<Strong style="color:grey;">Finden Sie Ihren Ansprechpartner weltweit</Strong><br/>
...
<strong style="color:grey;">Deutschland</Strong><br/>
Mo-Fr, 10:00 - 16:00 Uhr<br/>
&gt; 0800 1813649<br/>
&gt; <a href="//service.infocus.info" target="blank" class="">Stellen Sie uns Ihre Frage online</a><br/>
<br/>
<strong style="color:grey;">Asien-Pazifik-Region</Strong><br/>
<table >
<tr style="position:relative;left:-100;"><td>Mo-Fr:</td><td style="text-align:left;">9:00 - 17:00 Ortszeiz</td></tr>
...
<br>
<strong style="color:grey;">Europa, Mittlerer Osten &amp; Afrika</Strong><br/>
<table border="0px">
<tr style="position:relative;left:-100;">
<td>Mo-Fr:</td><td style="text-align:left;">08:00 - 17:00</td></tr>
<tr style="position:relative;left:-100;">
<td>Frankreich</td>
...
<area shape="poly" coords="221,98,211,93,210,77,230,76,239,84,234,93,253,112,249,122,258,131,254,142,258,154,269,157,280,149,282,145,291,142,297,138,297,130,295,126,298,119,303,112,307,110,311,110,318,110,334,107,332,108,336,106,336,100,330,101,328,96,327,89,325,84,325,77,320,63,313,46,300,33,297,26,288,24,294,44,297,68,293,81,284,93,272,100,263,104,261,105," Target="_Parent" href="//service.infocus.info" alt="Europe" title="Europe"   />
...
<h4>Ist Ihr Gerät defekt?</h4>
<h6>Zum Beispiel:</h6> Ihr Projektor geht nicht mehr an?<br>
<a href="#RMAUSCan-popup" id="open-RMAUSCan" class="colorbox-inline">Click Here</a>
<h4>Haben Sie eine allgemeine Frage?</h4>
<h6>Zum Beispiel:</h6> Wieviele Lumen benötige ich für einen kleinen Konferenzraum?<br>
<a class="form-box" href="/resources/forms/supportcontactus">Klicken Sie hier</a>
</div></div>  </div>
</div></section></div>
				<footer id="site-info" >
