...
<div class="swiper-slide" style="position:relative">
	...
	<div class="crop"><img id="ConX" src="/upload/homepage/InFocus_Videotelefonie_Cloud_ConX.jpg" border="0" /></div>
...
opacity: 0;
cursor: pointer;"  ></div>	
	 <div id="ytcover2" class="crop"><img id="ytcover3" style="" src="/upload/homepage/InFocus_Videotelefonie_Telefon.jpg"></div>

<a href="/video-communication/MVP100"><span style="position: absolute;
bottom: 11%;
background-color: #FFF;
width: 17.9%;
height: 14.5%;
...
<div class="swiper-slide" style="position:relative"> <div class="crop"><img style="" src="/upload/homepage/InFocus_Projektor_Beamer_LightPro_IN1146.jpg"></div>
<a href="/projectors/IN1146"><span style="position: absolute;
bottom: 25%;
background-color: #FFF;
width: 13.9%;
height: 9.5%;
...
<p align="center"><strong>Projektoren & Beamer in allen Größen und Leistungsklassen. Touchscreen-Lösungen für interaktive Zusammenarbeit.</strong></p>
 ...
 <div class="C4 Col image-set"><a href="/mondopad-live-demo"><div><img src="/resources/images/category-home-theater-projectors.png" alt="See a Live Mondopad Demo" /></div></a></div>
...
<div style="height:20px;"></div>
 ...
 <div class="C6 Col Col_child C5_child" style="margin-top:5.2%;">
 	...
 	Eine neue Dimensionen für Videokonferenzen und Präsentationen. Touchscreens in den Größen von 55 bis 70 Zoll und integrierter Hard- und Software als innovative Konferenz-Komplettlösung.<br>
...
<div style="height:20px;"></div>
 ...
 <div class="C4 Col image-set"><a href="/mondopad-live-demo"><div style="padding-top: 30px;
padding-left: 31px;"><img src="/resources/images/ConX-InFocus_Videoconferencing_Cloud.png" alt="See a Live Mondopad Demo" /></div></a></div>
